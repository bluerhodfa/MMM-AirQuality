...
module.exports = {
  ...
  loadData: async function (payload) {
    const self = this
    const url = `${payload.config.apiBase}${payload.config.apiVersion}${payload.config.apiEndPoint}/?lat=${payload.config.lat}&lng=${payload.config.lng}&apiKey=${payload.config.apiKey}`
